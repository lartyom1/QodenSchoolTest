...
namespace WebApp.Test
{
    ...
    public class MyTestBase
    {
        ...
        protected async Task<HttpClient> CreateAuthorizedClientAsync(string login)
        {
            ...
            client.DefaultRequestHeaders.Add(HeaderNames.Cookie, res.Headers.GetValues(HeaderNames.SetCookie));// res Headers do not contain Cookie Header ->
                                                                                                               // can't get cookie header -> can't create authorized client
                                                                                                               // however, postman can recieve and send cookie, authorization passes
            return client;
        }
    }
}